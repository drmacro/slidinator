...
import org.slidinator.slideset.datamodel.Div;
import org.slidinator.slideset.datamodel.Image;
import org.slidinator.slideset.datamodel.ListItem;
import org.slidinator.slideset.datamodel.ListSlideItem;
import org.slidinator.slideset.datamodel.OrderedList;
import org.slidinator.slideset.datamodel.Para;
import org.slidinator.slideset.datamodel.Preformatted;
import org.slidinator.slideset.datamodel.SimpleSlideSet;
import org.slidinator.slideset.datamodel.Slide;
import org.slidinator.slideset.datamodel.SlideBody;
import org.slidinator.slideset.datamodel.SlideGroup;
import org.slidinator.slideset.datamodel.SlideItem;
import org.slidinator.slideset.datamodel.SlideNotes;
import org.slidinator.slideset.datamodel.StyleDefinition;
import org.slidinator.slideset.datamodel.StyleType;
import org.slidinator.slideset.datamodel.TextRun;
import org.slidinator.slideset.datamodel.TitledSlidesItem;
import org.slidinator.slideset.datamodel.UnorderedList;
...
public class PPTXGeneratingSlideSetVisitor extends SlideSetVisitorBase {
    ...
    protected
        ...
        if (item instanceof Para) {
            ...
            // Silently ignore;
        } else if (item instanceof Preformatted) {
            renderPreformatted(xslfSlide, (Preformatted)item, pptxBody, nestLevel);
        } else {
    ...
    protected
        ...
        for (SlideItem item : textRuns) {
            if (item instanceof TextRun) {
                renderTextRun(xslfSlide, (SlideItem)item, pptxPara, props);
            } else {
    ...
    private
        ...
        if (item.getStyleName() != null) {
            ...
            if (props != null) {
                if (props.getFontFamily() != null) 
                    pptxTextRun.setFontFamily(props.getFontFamily());
                if (props.getFontSize() > 0) 
                    pptxTextRun.setFontSize(props.getFontSize());
                if (props.getFontColor() != null) 
                    pptxTextRun.setFontColor(props.getFontColor());
