...
<xsl:stylesheet
  ...
  <!-- =============================================================
       ...
       SlideSet to HTML Slidy Transformation
...
-->
  ...
  <xsl:param name="outdir" select="'./slidy'"/>
...
<!--
      ...
      <html lang="en" xml:lang="en"> <!--FIXME: lang needs to be specified by lang of calling XML file -->
        <head> 
          ...
          <link rel="stylesheet" type="text/css" media="screen, projection, print" 
            href="resources/styles/slidy.css" />
          <xsl:call-template name="defaultSlidinator2HTMLCSS" />
          <script src="resources/scripts/slidy.js" 
        ...
        <body>
          <!-- A presentation header design could go here, per the rules of slidy could go here -->
    ...
    <xsl:result-document href="{relpath:newFile($outdir, 'slidy.html')}" format="slide-html">
